export const product = {
  ...
  addToCart: {
    itemsAddedToYourCart: 'Item(s) added to your basket',
    itemsIncrementedInYourCart:
      'This item was already in your basket. The quantity was updated.',
    items: 'items',
    updatingCart: 'Updating basket...',
  ...
  TabPanelContainer: {
    tabs: {
      ...
      ProductSpecsTabComponent: 'Product Definition',
      ProductReviewsTabComponent: 'Reviews',
      ProductEquivalentsTabComponent: 'Automotive OE Equivalents',
      ProductCompatibilityTabComponent: 'Automotive Compatibility',
      ProductCalculFactorsTabComponent: 'Industry Calcul Factors',
  ...
  addToWishList: {
    ...
    anonymous: 'Sign in to add to shopping list',
  },
  stockNotification: {
    notifyMe: 'NOTIFY ME',
