export const common = {
  ...
  httpHandlers: {
    ...
    unauthorized: {
      common: 'You must be logged in to access this page',
    ...
    cartNotFound: 'Basket not found.',
    invalidCodeProvided: 'Invalid code provided.',
  },
  miniCart: {
    item: '{{count}} item currently in your basket',
    item_plural: '{{count}} items currently in your basket',
    total: '{{total}}',
    count: '{{count}}',
  },
  miniLogin: {
